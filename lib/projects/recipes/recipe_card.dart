          ...
          child: Center(
            child: MatrixTransition(
              ...
              child: const FittedBox(
                child: SizedBox(width: 230, height: 300, child: StacheStash()),
              ),
            ),
          ),
        );
...
class _StacheCubit extends Cubit<bool> {
...
class Stache extends HookWidget {
  ...
  final Widget child;
  static final _stache = _StacheCubit();
...
class RenderStache extends BigBox {
